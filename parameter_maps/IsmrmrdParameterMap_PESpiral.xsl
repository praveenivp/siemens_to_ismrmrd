            ...
            <encoding>
                ...
                <xsl:if test="siemens/MEAS/sKSpace/ucTrajectory = 4">
                    <trajectoryDescription>
                        <identifier>PESpiral</identifier>

                        <xsl:for-each select="siemens/MEAS/sNavigatorPara/alFree">
                        ...
                        <xsl:for-each select="siemens/MEAS/sNavigatorPara/adFree">   
                            ...
                            <xsl:if test="$CurDouble = 2" >
                            <userParameterDouble>
                                <name>MinRiseTime_us</name>
                                <value>
                                    <xsl:value-of select="."/>
                                </value>
                            </userParameterDouble>
                            ...
                            <xsl:if test="$CurDouble = 2" >
                            <userParameterDouble>
                                <name>Slewmax_mT_m_ms</name>
                                <value>
                                    <xsl:value-of select="1000 div ."/>
                                </value>
                            </userParameterDouble>
                            </xsl:if>
                            <xsl:if test="$CurDouble = 3" >
                            <userParameterDouble>
                                <name>Resolution_mm</name>
                                <value>
                                    <xsl:value-of select="."/>
                                </value>
                            </userParameterDouble>
                        ...
                        <comment>Using spiral design by Philip Eheses and mintimegradient optimisation by miki lustig
                        </comment> 
                    </trajectoryDescription>
                </xsl:if>
